...
| Project | Stack | Link | Date |
|---|---|---|---|
| DashPVA - Argonne National Laboratory | Python, PyQT5, SQLite | [→ View Repo](https://github.com/AdvancedPhotonSource/DashPVA) | 06/2025 - Current |
| Rime Co - Ecommerce Website | Python, Vite, Django, Stripe | [→ View Repo]([https://github.com/AdvancedPhotonSource/rime_co](https://github.com/Oluwa-Temmy/rime_co)) | 06/2025 - Current |
